  ...
  <div class="cart">
        ...
        <div class="info">
          ...
          <span class="bottom">
            <div class="price">¥ <span>{{
              ...
              <!-- 即希望保留原本的形参，又需要通过调用函数传参，可使用箭头函数包装一层  -->
    ...
    <div class="footer-fixed">
      ...
      <div class="all-total">
        ...
        <div
        @click="goPay"
        :class="{ disabled: selCount === 0 }" v-if="!isEdit" class="goPay">结算({{ selCount }})</div>
        <div
        @click="handleDel"
        :class="{ disabled: selCount === 0 }" v-else class="delete">删除</div>
      </div>
    </div>
  </div>
